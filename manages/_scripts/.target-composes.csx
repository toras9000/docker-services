...
static class ManageServices
{
    ...
    private static IReadOnlyList<ServiceInfo> containers { get; } = new ServiceInfo[]
    {
        ...
        new("certbot", Enabled: true,
            Compose: new(ThisSource.RelativeFile("../certbot/compose.yml"), Volumes: ["certbot-etc-data", "certbot-var-data"])
        ),
        ...
        new("Scrutiny", Enabled: true,
            Compose: new(ThisSource.RelativeFile("../scrutiny/compose.yml"), Volumes: ["scrutiny-db-data", "scrutiny-app-data"]),
        ...
        new("BookStack", Enabled: true,
            Compose: new(ThisSource.RelativeFile("../bookstack/compose.yml"), UpArgs: ["--wait"], Volumes: ["bookstack-db-data", "bookstack-app-data", "bookstack-redis-data"]),
