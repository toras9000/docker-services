...
static class ManageServices
{
    ...
    private static IReadOnlyList<ServiceInfo> containers { get; } = new ServiceInfo[]
    {
        ...
        new("ImageRegistry", Enabled: true,
            Compose: new(ThisSource.RelativeFile("../registry/compose.yml"), Volumes: ["registry-repos"]),
            Endpoints: [new("ImageRegistry", "https://registry-web.myserver.home"),]
        ),
        ...
        new("TimeTagger", Enabled: true,
            Compose: new(ThisSource.RelativeFile("../timetagger/compose.yml"), Volumes: ["timetagger-app-data"]),
            Endpoints: [new("TimeTagger", "https://timetagger.myserver.home")]
        ),
        ...
        new("BaGetter", Enabled: true,
            Compose: new(ThisSource.RelativeFile("../bagetter/compose.yml"), Volumes: ["bagetter-db-data", "bagetter-app-packages", "bagetter-app-keys"]),
            Endpoints: [new("BaGetter", "https://bagetter.myserver.home")]
        ),
        ...
        new("Kallithea", Enabled: true,
            Compose: new(ThisSource.RelativeFile("../kallithea/compose.yml"), UpArgs: ["--wait"], Volumes: ["kallithea-db-data", "kallithea-app-config", "kallithea-app-repos", "kallithea-app-hostkeys", "kallithea-app-ssh"]),
            Endpoints: [new("Kallithea", "https://kallithea.myserver.home")]
        ),
